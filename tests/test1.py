...
def test_robo_funciona():
    print("=====================================")
    print("INICIANDO TESTE DO ROBÔ")
    print("=====================================")
    ...
    # ====================================
    # TESTANDO PROBLEMA COM ALGORITMOS DE BUSCA
    # ====================================
    print("=====================================")
    print("TESTANDO PROBLEMA COM OUTROS ALGORITMOS")
    print("=====================================")

    # Use o estado inicial original aqui
